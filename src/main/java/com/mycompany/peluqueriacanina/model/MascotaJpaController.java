...
public class MascotaJpaController implements Serializable {
    ...
    public MascotaJpaController() {
        this.emf = Persistence.createEntityManagerFactory("com.mycompany_PeluqueriaCanina_jar_1.0PU");
    }
    ...
    public void edit(Mascota mascota) throws Exception {
        ...
        try {
            ...
            if (findMascota(mascota.getNum_cliente()) == null) {
                throw new Exception("La mascota con el número de cliente " + mascota.getNum_cliente() + " no existe.");
            }
            throw ex;
        } finally {
            if (em != null) {
    ...
    public void destroy(int id) throws Exception {
        ...
        try {
            ...
            try {
                ...
                throw new Exception("La mascota con el número de cliente " + id + " no existe.", ex);
            }
            em.remove(mascota);
            em.getTransaction().commit();
        } finally {
